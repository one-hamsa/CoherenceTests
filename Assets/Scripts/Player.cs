...
public class Player : MonoBehaviour
{
    ...
    private void SetupPlayer()
    {
        ...
        foreach (var part in _parts)
        {
            ...
            joint.xDrive = new JointDrive() { positionDamper = 50f, positionSpring = 15000f, maximumForce = maxForce };
            joint.yDrive = new JointDrive() { positionDamper = 50f, positionSpring = 15000f, maximumForce = maxForce };
            joint.zDrive = new JointDrive() { positionDamper = 50f, positionSpring = 15000f, maximumForce = maxForce };
            joint.rotationDriveMode = RotationDriveMode.Slerp;
            joint.slerpDrive = new JointDrive() { positionDamper = 50f, positionSpring = 15000f, maximumForce = maxForce };
