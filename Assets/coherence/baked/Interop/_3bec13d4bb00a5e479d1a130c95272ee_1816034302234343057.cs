...
namespace Coherence.Generated
{
    ...
    public struct _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057 : ICoherenceComponentData
    {
        ...
        public static unsafe _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 13) {
            ...
            var orig = new _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057();
        ...
        {
            var other = (_3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057)data;
        ...
        public static uint Serialize(_3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057();
            if (bitStream.ReadMask())
            {

                val.blah = bitStream.ReadBool();
                val.FieldsMask |= _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057.blahMask;
            }
            if (bitStream.ReadMask())
            {

                val.stam = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057.stamMask;
            }
        ...
        {
            return $"_3bec13d4bb00a5e479d1a130c95272ee_1816034302234343057(" +
                $" blah: { this.blah }" +
                $" stam: { this.stam }" +
