    ...
    public class DataInteropHandler : IDataInteropHandler
    {
        ...
        public unsafe void UpdateComponent(INativeCoreComponentUpdater updater, InteropEntity entity, ICoherenceComponentData component)
        {
            ...
            switch (componentType)
            {
                ...
                case 155:
                {
                    var orig = (_5adef152083604ef289a125a77765def_840763193699283319)component;
                    var val = new _5adef152083604ef289a125a77765def_840763193699283319.Interop();
        ...
        public unsafe IEntityCommand GetCommand(UInt32 type, IntPtr data, Int32 dataSize)
        {
            switch (type)
            {
                  ...
                  case 8: return _daaa1fa3f3526944a84e601f43726765_2351f7fda0244521b241827c0e01304f.FromInterop(data, dataSize);
            }
