...
namespace Coherence.Generated
{
    ...
    public struct _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363 : ICoherenceComponentData
    {
        ...
        public static unsafe _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363();
        ...
        {
            var other = (_7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363)data;
        ...
        public static uint Serialize(_7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.partIndex, _partIndex_Min, _partIndex_Max, "_7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363.partIndex", logger);
        ...
        public static _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363();
            if (bitStream.ReadMask())
            {

                val.partIndex = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363.partIndexMask;
            }
        ...
        {
            return $"_7aa047939d3aa49498cc38bb3ac3eec7_11687024536901363(" +
