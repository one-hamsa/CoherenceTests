...
namespace Coherence.Generated
{
    ...
    public struct _86637d6221845a54c80f4dee3a49e53e_8118622161289229957 : ICoherenceComponentData
    {
        ...
        public static unsafe _86637d6221845a54c80f4dee3a49e53e_8118622161289229957 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 13) {
            ...
            var orig = new _86637d6221845a54c80f4dee3a49e53e_8118622161289229957();
        ...
        {
            var other = (_86637d6221845a54c80f4dee3a49e53e_8118622161289229957)data;
        ...
        public static uint Serialize(_86637d6221845a54c80f4dee3a49e53e_8118622161289229957 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _86637d6221845a54c80f4dee3a49e53e_8118622161289229957 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _86637d6221845a54c80f4dee3a49e53e_8118622161289229957();
            if (bitStream.ReadMask())
            {

                val.blah = bitStream.ReadBool();
                val.FieldsMask |= _86637d6221845a54c80f4dee3a49e53e_8118622161289229957.blahMask;
            }
            if (bitStream.ReadMask())
            {

                val.stam = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _86637d6221845a54c80f4dee3a49e53e_8118622161289229957.stamMask;
            }
        ...
        {
            return $"_86637d6221845a54c80f4dee3a49e53e_8118622161289229957(" +
                $" blah: { this.blah }" +
                $" stam: { this.stam }" +
